document.addEventListener('DOMContentLoaded', () => {
    ...
    // ## MODIFICATION START ##
    // This function now handles both mouse and touch events to get coordinates.
    ...
    canvas.addEventListener('mouseleave', handleDragEnd); // Also end drag if mouse leaves canvas

    // Touch Events (NEW)
    canvas.addEventListener('touchstart', handleDragStart);
    canvas.addEventListener('touchmove', handleDragMove);
    canvas.addEventListener('touchend', handleDragEnd);
    canvas.addEventListener('touchcancel', handleDragEnd); // Also end drag if touch is cancelled
    // ## MODIFICATION END ##
